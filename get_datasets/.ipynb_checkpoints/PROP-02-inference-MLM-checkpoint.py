...
my_train_dataset   = PROPrandomMLMDataset(train_loader, model, tokenizer)

with open(f'../data/MLM/MLM-PROPrandom-train-ds.pkl', 'wb') as outp:
...
my_val_dataset     = PROPrandomMLMDataset(val_loader, model, tokenizer)

with open(f'../data/MLM/MLM-PROPrandom-val-ds.pkl', 'wb') as outp:
...
my_test_dataset    = PROPrandomMLMDataset(test_loader, model, tokenizer)

with open(f'../data/MLM/MLM-PROPrandom-test-ds.pkl', 'wb') as outp:
