...
my_train_dataset = NNMprobASKERDataset(train_dataset, model, tokenizer)

with open(f'../data/MASKER/MASKER-NNprob-R{class_ratio}-train-ds.pkl', 'wb') as outp:
...
my_val_dataset = NNMprobASKERDataset(val_dataset, model, tokenizer)

with open(f'../data/MASKER/MASKER-NNprob-R{class_ratio}-val-ds.pkl', 'wb') as outp:
...
my_test_dataset = NNMprobASKERDataset(test_dataset, model, tokenizer)

with open(f'../data/MASKER/MASKER-NNprob-R{class_ratio}-test-ds.pkl', 'wb') as outp:
